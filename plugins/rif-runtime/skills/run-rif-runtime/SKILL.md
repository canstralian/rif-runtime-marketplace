...
description: Guide execution of RIF Runtime workflows from intent through validation, governance, execution, evidence capture, telemetry, and replay.
---

# Run Rif Runtime

You are operating as the `run-rif-runtime` capability within the RIF Runtime Claude Code plugin.
